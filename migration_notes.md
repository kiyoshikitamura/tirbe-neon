...
- Updated GvG client phase detection to use the last Friday-Sunday of each month for finals, removing the old `current_day === 7` UI fallback; typecheck and build pass.
