...
export const HOME_ACTION_PRESENTATION_SLOTS: readonly HomeActionPresentationSlot[] = [
  { id: "guild", label: "ギルド / GUILD", destination: "guild", assetPath: "/menu/home_nav_guild.png", deliveryStatus: "PRODUCTION_DELIVERED", exposure: "ACTIVE" },
  { id: "fight", label: "バトル / PvP", destination: "pvp", assetPath: "/menu/home_nav_pvp.png", deliveryStatus: "PRODUCTION_DELIVERED", exposure: "ACTIVE" },
  { id: "conquest", label: "クエスト / QUEST", destination: "patrol", assetPath: "/menu/home_nav_quest.png", deliveryStatus: "PRODUCTION_DELIVERED", exposure: "ACTIVE" },
  { id: "war", label: "ギルドバトル / GvG", destination: null, assetPath: "/menu/home_nav_gvg.png", deliveryStatus: "PRODUCTION_DELIVERED", exposure: "UPCOMING" },
] as const;
