...
export const DEFAULT_LOGIN_BONUS_MASTERS: LoginBonusMaster[] = [
  ...
  { day_number: 5, item_id: 'NORMAL_GACHA_TICKET', quantity: 1, is_featured: true, item_name: 'ノーマルガチャチケット 1枚' },
  ...
  { day_number: 10, item_id: 'NORMAL_GACHA_TICKET', quantity: 2, is_featured: true, item_name: 'ノーマルガチャチケット 2枚' },
  ...
  { day_number: 15, item_id: 'NORMAL_GACHA_TICKET', quantity: 3, is_featured: true, item_name: 'ノーマルガチャチケット 3枚' },
  ...
  { day_number: 20, item_id: 'NORMAL_GACHA_TICKET', quantity: 5, is_featured: true, item_name: 'ノーマルガチャチケット 5枚' },
  ...
  { day_number: 25, item_id: 'NORMAL_GACHA_TICKET', quantity: 5, is_featured: true, item_name: 'ノーマルガチャチケット 5枚' },
  ...
  { day_number: 30, item_id: 'NORMAL_GACHA_TICKET', quantity: 10, is_featured: true, item_name: 'ノーマルガチャチケット 10枚' }
];
