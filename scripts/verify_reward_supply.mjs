...
for (const source of ["PVP", "RAID", "RANKING"]) assert.equal(sources.get(source).status, "PENDING_FREEZE");
...
console.log("Reward Supply verification PASS: Mission, Login and Quest frozen; PvP/Raid/Ranking pending freeze.");
