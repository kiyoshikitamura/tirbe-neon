...
const requiredScenarios = [
  ...
  "first-home-favorite-missing", "first-home-favorite-invalid", "first-home-activity-self", "first-home-character-tall", "first-home-character-hair", "first-home-campaign",
];
