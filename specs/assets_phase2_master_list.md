# 【TRIBE: NEON REIGN】Phase 2 グラフィックアセット全再定義 ＆ 統合マスターリスト (Assets Master List)
...
| :--- | :--- | :--- | :--- |
| **拠点背景** | **新宿 歌舞伎町** | `/bg/bg_shinjuku.jpg` | 新宿拠点滞在時のマイページビジュアル背景 |
| **拠点背景** | **渋谷 センター街** | `/bg/bg_shibuya.jpg` | 渋谷拠点滞在時のマイページビジュアル背景 |
| **拠点背景** | **池袋 裏通り** | `/bg/bg_ikebukuro.jpg` | 池袋拠点滞在時のマイページビジュアル背景 |
| **拠点背景** | **六本木 ナイトクラブ前** | `/bg/bg_roppongi.jpg` | 六本木拠点滞在時のマイページビジュアル背景 |
| **拠点背景** | **秋葉原 ジャンク街** | `/bg/bg_akihabara.jpg` | 秋葉原拠点滞在時のマイページビジュアル背景 |
| **拠点背景** | **川崎 工場地帯** | `/bg/bg_kawasaki.jpg` | 川崎拠点滞在時のマイページビジュアル背景 |
| **拠点背景** | **横浜 港湾エリア** | `/bg/bg_yokohama.jpg` | 横浜拠点滞在時のマイページビジュアル背景 |
| **バトル背景** | **ネオンタワー屋上** | `/bg/bg_battle_tower.jpg` | GvG・ネオンタワー抗争用バトル背景 |
| **バトル背景** | **ディープドック廃倉庫** | `/bg/bg_battle_dock.jpg` | GvG・ディープドック抗争用バトル背景 |
| **バトル背景** | **歓楽街路地** | `/bg/bg_battle_street.jpg` | クエスト・PvP対戦用基本バトル背景 |
| **バトル背景** | **闇カジノフロア** | `/bg/bg_battle_casino.jpg` | レイドボス（新宿カイザー）戦用バトル背景 |
| **画面背景** | **ガチャ演出背景** | `/bg/bg_gacha.jpg` | ガチャ画面および排出演出時の背景グラフィック |
| **画面背景** | **ギルド本部アジト** | `/bg/bg_guild_hall.jpg` | ギルド画面の装飾ベース背景 |
