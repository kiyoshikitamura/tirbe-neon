...
const seedProfile = async (page: import("@playwright/test").Page) => {
  await page.addInitScript(() => {
    ...
    localStorage.setItem("mock_db_users", JSON.stringify([{ id: userId, username: "設定確認", bio: "新宿で活動中", current_base_id: "shinjuku", favorite_character_id: "char_reiji_01", title_equipped: "title_none" }]));
