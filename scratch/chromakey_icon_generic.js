...
async function processChromaKey(inputName, outputName) {
  const inputPath = path.join(__dirname, '../public/raw_assets', inputName);
...
const inputName = process.argv[2] || 'icon_dia_raw.jpg';
const outputName = process.argv[3] || 'icon_dia.png';

processChromaKey(inputName, outputName).catch(err => {
